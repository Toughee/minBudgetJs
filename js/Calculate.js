function calculate1() {
        var a = document.getElementById("qty1-class1").value  / 52 / 40;
            document.getElementById("num1").innerHTML = 'Your total gross pay rate per hour equals to '+ a;
    }
    function calculate2() {
    ...
    function calculate4() {
        ...
        var d8 = d4 + d7;
            document.getElementById("num4").innerHTML = 'Your total cost for visiting The ' + d1 + ' would be ' + d8;
    }
